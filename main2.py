...
if uploaded_file is not None:
    ...
    for i in range(len(df)):
        if df['Classificació'][i] == 'SUC':
            df.loc[i,'Classificació'] = 'Sòl urbà consolidat'
        elif df['Classificació'][i] == 'SNC':
            df.loc[i,'Classificació'] = 'Sòl urbà NO consolidat'
        elif df['Classificació'][i] == 'SUD':
            df.loc[i,'Classificació'] = 'Sòl urbanitzable delimitat'
        elif df['Classificació'][i] == 'SND':
            df.loc[i,'Classificació'] = 'Sòl urbanitzable no delimitat'
        elif df['Classificació'][i] == 'SNU':
            df.loc[i,'Classificació'] = 'Sòl no urbanitzable'
